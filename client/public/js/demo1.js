...
function createLandscape(params, container_class, rotation_param, y_cam, z_cam){
  ...
  function sceneSetup(){
    ...
    camera.position.y = y_cam;
    camera.position.z = z_cam;
    camera.rotation.x = rotation_param;
